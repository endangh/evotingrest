	...
	public List<Kandidat> getKandidat() {
		// TODO Auto-generated method stub
			...
			try {
				...
				while (rs.next()) {
					list.add(new Kandidat(rs.getInt("id_kandidat"),rs.getString("nama_kandidat"),rs.getString("url_photo_kandidat"),rs.getString("visi_kandidat"),rs.getString("misi_kandidat"),rs.getString("periode"),rs.getBoolean("status_kandidat")));
				}
